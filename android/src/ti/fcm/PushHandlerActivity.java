...
public class PushHandlerActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		try {
			...
			String notification = getIntent().getStringExtra(FcmModule.INTENT_EXTRA);
			...
			if (TiApplication.getAppRootOrCurrentActivity() == null) {
				...
				if (module != null) {
					FcmModule.getModule().sendMessage(notification, true);
				}
			}

			launcherIntent.putExtra(FcmModule.INTENT_EXTRA, notification);
